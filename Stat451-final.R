...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      div(
        checkboxGroupInput("selected_age", "Select Age(s) for plot ",
    ...
    mainPanel(tabsetPanel(
      tabPanel("Plot of different race", plotOutput("line_plot"),plotOutput("histogram_plot")),
      tabPanel("Plot of different age", plotOutput("line_plot2"),)
      )
